...
function cursos_iglesia_add_theme_scripts(){
    ...
    wp_enqueue_style('postStyle', get_stylesheet_directory_uri() . '/assets/css/style_post.css');
    wp_enqueue_style('pageStyle', get_stylesheet_directory_uri() . '/assets/css/style_page.css');
